...
void main()
{
    unsigned char control_flag = 0X00;
    ...
    unsigned char gr = 0;
    unsigned char key = 0x3F, pressed_key = 0x3F, stored;
    ...
    while(1)
    {
        ...
        if(key == 0x3F)
        {
            ...
            else if( (pressed_key == 0x37 || pressed_key == 0x2F) && control_flag == 0X00 )
            {
                control_flag = 0X01;
            ...
            else if(pressed_key == 0x37 && delay > 5)
            {
                ...
                else if(control_flag == 0x61){
                    clear_screen();
                    control_flag = 0X02;
                    reset_flag = 0x55;
                }
                else if(control_flag == 0x64)
                {
                    clear_screen();
                    control_flag = 0X00;
                    reset_flag = 0x22;
            ...
            else if(pressed_key == 0x2F && control_flag == 0X02 && delay > 5)
            {
            ...
            else if((pressed_key == 0x2F || pressed_key == 0x37) && control_flag == 0x62)
            {
                control_flag = 0X02;
                reset_flag = 0x55;
            }
        ...
        switch(control_flag)
        {
            ...
            case 0x64:
                clear_screen();
                if(set_time(pressed_key, reset_flag) == 0x60){
                    control_flag = 0X00;
                    reset_flag = 0x22;
                }
                break;
            case 0x65:
                if(change_pwd(pressed_key, reset_flag) == 0x70){
                    control_flag = 0X00;
                    reset_flag = 0x55;
                }
                else if(change_pwd(pressed_key, reset_flag) == 0x71){
                    reset_flag = 0x55;
                    control_flag = 0X02;
                }
                break;
